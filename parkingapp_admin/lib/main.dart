...
void main() async {
  await HydratedBlocOverrides.runZoned(
    () async {
      ...
      // Removed invalid setter usage as storage is already set in HydratedBlocOverrides.runZoned
...
// // This function updates the dark mode setting in SharedPreferences
// // and notifies the ValueNotifier to update the UI.
// Future<void> _updateDarkMode(bool isDarkMode) async {
//   final prefs = await SharedPreferences.getInstance();
//   await prefs.setBool('isDarkMode', isDarkMode);
//   isDarkModeNotifier.value = isDarkMode;
